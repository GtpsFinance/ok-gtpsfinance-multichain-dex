...
const ReactApp = () => {
  ...
  return (
    <StrictMode>
      <SEO
        title="GtpsFinanceSwap - Swap and earn tokens at the best rates"
        description="GtpsFinanceSwap is DeFi’s first Dynamic Market Maker; a decentralized exchange protocol that provides frictionless crypto liquidity with extremely high flexibility and capital efficiency. KyberSwap is the first major protocol in Kyber’s liquidity hub."
      />
      <FixedGlobalStyle />
