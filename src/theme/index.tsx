...
function colors(darkMode: boolean): Colors {
  return {
    ...
    // backgrounds
    background: darkMode ? '#0D0BB1' : '#ffffff',
    background2: darkMode ? '#0D0BB1' : '#f5f5f5',
    tabActive: darkMode ? '#313131' : '#ffffff',
    tabBackgound: darkMode ? '#0D0BB1' : '#E2E2E2',

    tableHeader: darkMode ? '#313131' : '#FBFBFB',
    buttonBlack: darkMode ? '#0D0BB1' : '#f5f5f5',
    buttonGray: darkMode ? '#292929' : '#E2E2E2',

    text2: darkMode ? '#C3C5CB' : '#000A00',
    text3: darkMode ? '#6C7284' : '#000B00',
    text4: darkMode ? '#000A00' : '#C3C5CB',
    text6: darkMode ? '#6d8591' : '#000A00',
    text7: darkMode ? '#c9d2d7' : '#000A00',
    text9: darkMode ? '#000000' : '#000000',
    text10: darkMode ? '#00a2f7' : '#00a2f7',
    text11: darkMode ? '#f4f4f4' : '#000A00',
