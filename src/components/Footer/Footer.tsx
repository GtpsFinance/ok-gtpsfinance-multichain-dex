...
export const FooterSocialLink = () => {
  ...
  return (
    <Flex alignItems="center" justifyContent="center" sx={{ gap: '24px' }}>
      <ExternalLinkNoLineHeight href="https://twitter.com/GtpsFinance">
      ...
      <FooterContent>
        <InfoWrapper>
          <Item>
            ...
            <ExternalLink href="https://gtpsfinance.org" style={{ display: 'flex' }}>
          ...
          <Item>
            ...
            <ExternalLink href="www.gtpsfinance.org" style={{ display: 'flex' }}>
              <img
                src={!isDarkMode ? 'https://svgshare.com/i/ofe.svg' : require('assets/svg/chainsecurity.svg').default}
                alt=""
                width="98px"
              />
            </ExternalLink>
