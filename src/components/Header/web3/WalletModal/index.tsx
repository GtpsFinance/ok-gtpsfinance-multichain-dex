      ...
      <UpperSection>
        ...
        {(walletView === WALLET_VIEWS.ACCOUNT || walletView === WALLET_VIEWS.CHANGE_WALLET) && (
          <TermAndCondition>
            ...
            <ToSText>
              <Trans>Accept</Trans>{' '}
              <ExternalLink href="/Gtps.Financewhitepaper.pdf">
                <Trans>Terms of Use</Trans>
              </ExternalLink>{' '}
              <Trans>and</Trans>{' '}
              <ExternalLink href="https://img1.wsimg.com/blobby/go/c7730dfb-3aa3-4420-b365-7cb76e6b33f3/downloads/Global%20Transaction%20Payment%20Solution%20WHITEPAPER.pdf?ver=1669768380715.pdf">
